  ...
  return (
    <>
      <div className="Manageuser-container rounded-lg shadow-md border-0 bg-white relative p-4">
        <h2 className="fw-bold pb-4">Manage Badges</h2>
        <div className="d-flex justify-content-between align-items-center pb-4">
          ...
          <div className="flex">
            <Link to="/Addbadges">
              <button className="ms-2 bg-[#067bbd] text-white py-2.5 px-3 fs-6 rounded-lg">
                Add New Badges
              </button>
            </Link>
          </div>
        ...
        <div class=" rounded-lg  shadow-md tb-container">
          <Table hover>
            <thead className="bg-[#067bbd] text-white text-lg">
              <tr>
                <th className="px-6 py-4  text-center ">Badge name</th>
            ...
            <tbody>
              <tr>
                <td className="flex gap-3 px-6 py-4 font-normal justify-content-center align-items-center text-gray-900">
                  <span className='rounded-3xl bg-green-200 text-green-600 px-3 py-1'>bff</span>
                </td>
              ...
              <tr>
                <td className="flex gap-3 px-6 py-4 font-normal justify-content-center align-items-center text-gray-900">
                  <span className='rounded-3xl bg-red-200 text-red-600 px-3 py-1'>
                    Lover
                  </span>
                </td>
                <td className=" px-6 py-4 font-normal text-center text-gray-900">
              ...
              <tr>
                <td className="flex gap-3 px-6 py-4 font-normal justify-content-center align-items-center text-gray-900">
                  <span className='rounded-3xl bg-orange-200 text-orange-600 px-3 py-1'>
                    Best Friends
                  </span>
                </td>
                <td className=" px-6 py-4 font-normal text-center text-gray-900">
